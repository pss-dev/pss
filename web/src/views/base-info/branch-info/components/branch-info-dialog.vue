  ...
  <el-dialog
    ...
    :before-close="handleClose">
      <el-form :model="branchData" ref="branchData" :rules="rules" class="demo-ruleForm">
        <el-form-item label="分支编号" prop="branchID" :label-width="formLabelWidth">
        ...
        <el-form-item label="客户" :label-width="formLabelWidth">
          <el-input v-model="branchData.customer" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="供货商" :label-width="formLabelWidth">
          <el-input v-model="branchData.supplier" autocomplete="off"></el-input>
        </el-form-item>
